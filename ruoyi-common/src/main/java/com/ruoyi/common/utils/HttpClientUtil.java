...
public class HttpClientUtil {
	...
	public static String post(String url, HttpClient client) {
		...
		try {
			...
			throw new BussException("发送post请求失败");
		} finally {
			// 释放连接
			method.releaseConnection();
		}
...
//	}
	...
	public static HttpClient login(String url, Map<String, String> params) {
		...
		try {
			...
			throw new BussException("登陆系统失败");
		} finally {
	...
	public static String postXML(String url, File xmlFile, HttpClient client) {
		...
		PostMethod post = new PostMethod(url);
		try {
			RequestEntity requestEntity = new StringRequestEntity(FileUtils.readFileToString(xmlFile), "text/xml", DEFAULT_CHARSET);
			...
			throw new BussException("提交xml失败");
		} finally {
			post.releaseConnection();
		}
		return resp;
	...
	public static String fileUpload(String url, Map<String, String> fileMap, HttpClient client) {
		...
		try {
			...
			throw new BussException("上传文件失败");
		} finally {
